...
/**
 * Course enrolment entity class implementation.
 *
 * @package    core_course
 * @author     Dan Marsden
...
class course_enrolments extends base {
    ...
    protected function get_default_table_aliases(): array {
        return [
            'enrol' => 'cee',
            'user_enrolments' => 'ceue',
            'role' => 'cer',
            'user_lastaccess' => 'ceul',
        ];
    }
    ...
    protected function get_default_entity_title(): lang_string {
        return new lang_string('enrolments', 'enrol');
    }
    ...
    protected function get_all_columns(): array {
        ...
        $columns[] = (new column(
            'timestart',
            new lang_string('enroltimestart', 'enrol'),
        ...
        $columns[] = (new column(
            'timeend',
            new lang_string('enroltimeend', 'enrol'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
